...
def make_dot_button(dote):
    return tk.Button(text=dote, bd=5, font=('Arial', 13), fg='red',command=lambda : add_dote(dote))
...
win.grid_columnconfigure(3, minsize=60, weight=1000)
